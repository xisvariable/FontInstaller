...
def install_fonts(directory):
    ...
    files = os.listdir("C:/Users/Hp/Downloads/Downloads")

    # Filter only the font files (you may need to customize this based on the types of font files you have)
    ...
    for font_file in font_files:
        font_path = os.path.join("C:/Users/Hp/Downloads/Downloads", font_file)
